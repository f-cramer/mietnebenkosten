...
class BillingExporter(
    ...
    fun export(
        ...
        val jasperPrint = createJasperPrint(json, parameters) { resourceLoader.getResource("classpath:/reports/billings-json.jasper").inputStream }
    ...
    protected fun createJasperPrint(source: String, parameters: Map<String, Any>, reportSupplier: () -> InputStream): JasperPrint {
        ...
        reportSupplier().use { report -> return JasperFillManager.fillReport(report, parameters, dataSource) }
    }
